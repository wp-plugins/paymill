...
* Common: Payment channel ELV switched to SEPA
* WooCommerce: Bug fixed not saving user ID in DB for subscription log
* WooCommerce: Now supporting hook-syncing of subscription cancellation, failure and subscription payment success - taking these actions in Paymill dashboard will now be synced with WooCommerce automatically via webhooks).
* PayButton: No order ID generated with subscriptions - fixed.
