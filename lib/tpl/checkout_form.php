...
?>
	...
	<?php
		...
		if(
			(
				...
				|| (esc_attr($GLOBALS['paymill_settings']->paymill_general_settings['payments_display']['sepa']) == 1)
			)
	...
	?>
		<div id="form-switch-elv" class="paymill_form-switch paymill_form-switch<?php if($show_elv === true){ echo '_active'; } ?>"><?php echo __('SEPA', 'paymill'); ?></div>
	<?php
		}
	?>
	...
	<div id="form-elv"<?php if($show_elv === false){ echo ' style="display:none;"'; } ?>>	
		<div class="form-row">
			<label translate="iframe"><?php echo __('IBAN', 'paymill'); ?></label>
			<input id="transaction-form-account" class="paymill_elv_number" type="text" value="" autocomplete="off"  maxlength="31">
		</div>
		<div class="form-row">
			<label translate="iframe"><?php echo __('BIC', 'paymill'); ?></label>
			<input id="transaction-form-code" class="paymill_elv_bank" type="text" value="" autocomplete="off"  maxlength="11">
		</div>
	</div>
