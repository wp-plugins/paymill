...
?>
		<div class="paymill_product paymill_product_<?php echo $id; ?>">
			...
			<?php if($GLOBALS['paymill_loader']->paymill_errors->status()){ ?>
			<div id="paymill_errors"><div><strong><?php echo __('Error', 'paymill'); ?></strong></div><?php echo $GLOBALS['paymill_loader']->paymill_errors->getErrors(); ?></div>
			<?php } ?>
