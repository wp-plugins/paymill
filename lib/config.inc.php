...
class paymill_settings{
	...
	function field_general_option($args) {
		if(paymill_BENCHMARK)paymill_doBenchmark(true,'paymill_field_general_option'); // benchmark
		$descriptions = array();
		...
		if(paymill_BENCHMARK)paymill_doBenchmark(false,'paymill_field_general_option'); // benchmark
	}
	...
	function add_admin_menus() {
		...
		add_menu_page('Paymill', 'Paymill', 'manage_options', $this->plugin_options_key, array( &$this, 'plugin_options_page' ),  plugins_url('',__FILE__ ).'/img/icon.png');
